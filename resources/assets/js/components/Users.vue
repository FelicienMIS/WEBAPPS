          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Table utilisateur</h3>

                <div class="card-tools">
                    <button class="btn btn-success" @click="newModal">Ajouter un utilisateur <i class="fas fa-user-plus fa-fw"></i></button>
                </div>
              </div>
              <!-- /.card-header -->
    ...
    <!-- Modal -->
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <select name="type" v-model="form.type" id="type" class="form-control" :class="{ 'is-invalid': form.errors.has('type') }">
                            ...
                            <option value="ecolePrimaire">EcolePrimaire</option>
                        </select>
                ...
                <div class="modal-footer">
                    ...
                    <button v-show="!editmode" type="submit" class="btn btn-primary">Creer</button>
                </div>
