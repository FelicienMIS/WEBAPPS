...
export default {
  ...
  mounted() {
    ...
    let trailheadsRenderer = {type: "simple",symbol: {type: "picture-marker",url: "http://static.arcgis.com/images/Symbols/NPS/npsPictograph_0105b.png",width: "18px",height: "18px"}}

      var myPointsFeatureLayer = new FeatureLayer({
          //*** Replace with your URL ***//
          url: "https://services8.arcgis.com/oTalEaSXAuyNT7xf/arcgis/rest/services/ecoleprimaire/FeatureServer/0",
