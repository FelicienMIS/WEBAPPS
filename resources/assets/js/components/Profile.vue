                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show" id="settings">
                                ...
                                <div class="form-group">
                                    <label for="password" class="col-sm-12 control-label">Mot de passe (leave empty if not changing)</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <button @click.prevent="updateInfo" type="submit" class="btn btn-success">Mise à jour</button>
                                    </div>
                                </div>
                                </form>
                            </div>
